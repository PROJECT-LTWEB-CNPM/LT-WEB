DROP DATABASE IF EXISTS shoplanedb;
CREATE DATABASE shoplanedb;
use shoplanedb;
...
-- Áo 
INSERT INTO shoplanedb.Categories(category_id, category_name, product_type)
...
-- shirt
INSERT INTO shoplanedb.Products(product_id, product_type, product_name, old_price, new_price, main_image_url, category_id, meterial, origin, pattern)
...
INSERT INTO shoplanedb.Sizes(size_id, size_name)
VALUES('SIZES', N'S');
INSERT INTO shoplanedb.Sizes(size_id, size_name)
VALUES('SIZEM', N'M');
INSERT INTO shoplanedb.Sizes(size_id, size_name)
...
INSERT INTO shoplanedb.Colors(color_id, color_name)
VALUES('COL1', N'RED');
INSERT INTO shoplanedb.Colors(color_id, color_name)
VALUES('COL2', N'BLACK');
INSERT INTO shoplanedb.Colors(color_id, color_name)
...
INSERT INTO shoplanedb.`Options`(option_id, available_quantity, product_id, color_id, size_id)
