...
INSERT INTO ltwebdb.ProductTypes(type_id, type_name)
VALUE ('AO', 'Áo');
INSERT INTO ltwebdb.ProductTypes(type_id, type_name)
VALUE ('QUAN', 'Quần');
...
-- Áo 
INSERT INTO ltwebdb.Categories(category_id, category_name, product_type)
...
-- shirt
INSERT INTO ltwebdb.Products(product_id, product_type, product_name, old_price, new_price, main_image_url, category_id, meterial, origin, pattern)
...
INSERT INTO ltwebdb.Sizes(size_id, size_name)
VALUES('SIZES', N'S');
INSERT INTO ltwebdb.Sizes(size_id, size_name)
VALUES('SIZEM', N'M');
INSERT INTO ltwebdb.Sizes(size_id, size_name)
...
INSERT INTO ltwebdb.Colors(color_id, color_name)
VALUES('COL1', N'RED');
INSERT INTO ltwebdb.Colors(color_id, color_name)
VALUES('COL2', N'BLACK');
INSERT INTO ltwebdb.Colors(color_id, color_name)
...
INSERT INTO ltwebdb.`Options`(option_id, available_quantity, product_id, color_id, size_id)
...
-- insert images
INSERT INTO ltwebdb.ProductImages(image_id, image_url, product_id)
