					...
					<div class="grid__column">
						<div class="category__container">
							...
							<ul class="category-list">
								<li
									class="category-item ${categoryId == 'AO5' || categoryId == 'QUAN4' ? 'active' : ''}"><a
									href="<%=context%>/collection?category_id=AO5&category_type=${categoryType}"
									class="category-item__link">TẤT CẢ SẢN PHẨM</a></li>
								<c:forEach var="item" items="${cates}">
									<li
										class="category-item ${categoryId == item.getCategoryId() ? 'active' : ''}"><a
