...
public class ProductService {
  ...
  public void handleGetShowProductList(String url) throws ServletException, IOException {
    ...
    try {
      List<Product> products = this.productDAO.findAll(queryString);
  ...
  public void handleGetCreateProduct() throws ServletException, IOException {
    ...
    List<Category> categories = this.categoryDAO.findAll("Category.findAll");
    List<ProductType> productTypes = this.productTypeDAO.findAll("ProductType.findAll");
